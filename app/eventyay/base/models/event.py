...
class Event(
    ...
    def social_image(self):
        ...
        if not img:
            ...
            elif self.visible_preview_image_url:
                img = self.visible_preview_image_url
    ...
    def social_image_signature(self):
        ...
        image_source = (
            og_image
            or self.visible_header_image_url
            or self.visible_preview_image_url
            or self.visible_logo_url
            or ''
        )
        if not image_source:
            return ''
